...
/**
 * This is the item provider adapter for a {@link mymetamodel.Ressource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.RESSOURCE__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.RESSOURCE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCheminPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_chemin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_chemin_feature", "_UI_Ressource_type"),
				 MymetamodelPackage.Literals.RESSOURCE__CHEMIN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_ue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_ue_feature", "_UI_Ressource_type"),
				 MymetamodelPackage.Literals.RESSOURCE__UE,
				 true,
				 false,
				 true,
				 null,
