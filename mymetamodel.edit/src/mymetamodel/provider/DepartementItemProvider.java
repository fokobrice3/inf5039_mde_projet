...
/**
 * This is the item provider adapter for a {@link mymetamodel.Departement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.DEPARTEMENT__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.DEPARTEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.DEPARTEMENT__RESPONSABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Departement_chef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Departement_chef_feature", "_UI_Departement_type"),
				 MymetamodelPackage.Literals.DEPARTEMENT__CHEF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MymetamodelPackage.Literals.DEPARTEMENT__FORMATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MymetamodelPackage.Literals.DEPARTEMENT__FORMATION,
				 MymetamodelFactory.eINSTANCE.createFormation()));
	}
