 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Enumération « Homme » et « Femme »
 * <!-- end-model-doc -->
 * @see mymetamodel.MymetamodelPackage#getSEXE()
 * @model
 * @generated
 */
public enum SEXE implements Enumerator {
	 ...
	 * @ordered
	 */
	public static final int HOMME_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int FEMME_VALUE = 1;
	...
	public static SEXE get(int value) {
		switch (value) {
			case HOMME_VALUE: return HOMME;
			case FEMME_VALUE: return FEMME;
		}
		return null;
	}
